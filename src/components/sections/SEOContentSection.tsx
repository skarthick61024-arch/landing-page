  ...
  return (
    <section className="bg-[#000000] py-16 border-t border-[#141518]">
      <div className="container mx-auto px-5 md:px-12 max-w-[800px] text-[#8D919B]">
        ...
        <div>
          <h2 className="text-[24px] font-bold text-[#F5F5F5] mb-4">Why Use TeleTorrent?</h2>
          <p className="text-[15px] leading-[1.6]">
            Unlike typical browsers or generic file managers, TeleTorrent is built exclusively to integrate 
            with your Telegram account. By focusing purely on your Saved Messages, it cuts out the clutter of 
            chat threads and channels, giving you a dedicated workspace to manage and download your content efficiently.
          </p>
        </div>
